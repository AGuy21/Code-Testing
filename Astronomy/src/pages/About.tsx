  ...
  return (
    <Container size="md" className="py-12 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-indigo-300 via-purple-300 to-blue-300 bg-clip-text text-transparent tracking-[0.08em]">Stars</h3>
        ...
        <Card>
          <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-indigo-300 via-purple-300 to-blue-300 bg-clip-text text-transparent tracking-[0.08em]">Planets</h3>
          <p className="text-indigo-200/80 tracking-[0.04em]">
