  ...
  return (
    ...
    >
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Add Pet's Name Here"
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Add Pet's Breed Here"
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          style={styles.input}
          placeholder="Add Pet's Age Here"
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          keyboardType="numeric"
          style={styles.input}
          placeholder="Add Pet's Weight Here"
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Add Pet's Address Here"
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Add Info About Your Pet Here"
